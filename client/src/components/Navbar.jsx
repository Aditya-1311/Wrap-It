...
const Navbar = () => {
  ...
  const adminEmail = 'krishnaaditya0170@gmail.com'; // Set your admin email here
  ...
  return (
    <nav className=" flex items-center justify-between px-6 py-3 bg-white bg-gradient-to-r from-blue-50 to-purple-100 shadow-lg">
      <div className=" flex items-center gap-2 mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <span className=" text-2xl font-bold text-purple-700 tracking-wide">Wrap It</span>
